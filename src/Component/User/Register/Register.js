...
const Register = () => {
    ...
    return (
        <section className="flex justify-center lg:p-6  text-gray-50 lg:mt-20">
            <div className=' border-2 lg:w-4/12  w-12/12 bg-[#5aa9ce] rounded-lg'>
                ...
                <form onSubmit={handleSubmit(handleSignUpForm)} className="my-10 ">
                    <div className='lg:flex pl-4 lg:space-x-20 lg:pl-10'>
                        <dir className='p-0 '>
                    ...
                    <div className='ml-4 lg:ml-10 space-y-5'>
                        <div>
                    ...
                    <button className='bg-white text-black px-8 py-2 mt-5 lg:ml-10 ml-20'>Submit</button>
                    <p className=' text-black  mt-5 lg:ml-10 ml-3'>Already Have an Account Please: <Link to={"/login"} className='text-yellow-500'>Log in</Link></p>
                </form>
            </div>
        </section>
    );
