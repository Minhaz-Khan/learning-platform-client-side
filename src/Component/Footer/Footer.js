            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">ULEARNING</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <Link to={'courses'}>
                            <h3 className="tracking-wide uppercase dark:text-gray-50">COURSES</h3></Link>
                    ...
                    <div className="space-y-3">
                        <Link to={'/faq'}>
                            <h3 className="tracking-wide uppercase dark:text-gray-50">FAQ</h3></Link>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <Link to={'/blog'}>
                            <h3 className="tracking-wide uppercase dark:text-gray-50">BLOG</h3></Link>
                        <ul className="space-y-1">
                            <li>
